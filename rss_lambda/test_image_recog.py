...
from .image_recog.image_recog import image_recog
...
def fake_yolov3(image_path: str, desired_class_id: int):
    time.sleep(0.1)
...
class ImageRecognitionTestCase(unittest.TestCase):
    ...
    @patch('rss_lambda.image_recog.image_recog.yolov3', wraps=fake_yolov3)
    def test_image_recognition(self, _):
        with self.assertLogs('root', level='INFO') as log_context_manager:
            ...
            self.assertEqual(
                image_recog(rss_text, 0, 'http://nitter.example.com/twitter_handle'),
            ...
            self.assertEqual(
                image_recog(rss_text_2, 0, 'http://nitter.example.com/twitter_handle'),
                nitter_rss20_processed_response)
